...
@section('content')
    <section id="hero" class="hero">
        <div
            class="swiper hero-swiper swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden">
            <div class="swiper-wrapper hero-wrapper" id="swiper-wrapper-a0391a133eaa9946" aria-live="off"
                style="transition-duration: 0ms; transition-delay: 0ms;">
                <div class="swiper-slide hero-slider-one swiper-slide-prev" role="group" aria-label="1 / 3"
                    style="width: 794px; opacity: 1; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                    <div class="container">
                        <div class="col-lg-6">
                            <div class="wrapper-section aos-init aos-animate" data-aos="fade-up">
                ...
                <div class="swiper-slide hero-slider-two swiper-slide-visible swiper-slide-active" role="group"
                    aria-label="2 / 3"
                    style="width: 794px; opacity: 0.974811; transform: translate3d(-814px, 0px, 0px); transition-duration: 0ms;">
                    <div class="container">
                        <div class="col-lg-6">
                ...
                <div class="swiper-slide hero-slider-three swiper-slide-next" role="group" aria-label="3 / 3"
                    style="width: 794px; opacity: 0; transform: translate3d(-1628px, 0px, 0px); transition-duration: 0ms;">
                    <div class="container">
                        <div class="col-lg-6">
                            <div class="wrapper-section">
                                <div class="wrapper-info">
        ...
        <div class="container">
            <div class="style-section">
                <div class="row gy-4 gx-5 gy-lg-0">
                    <div class="col-lg-6">
                        <div class="product-wrapper wrapper-one aos-init" data-aos="fade-right">
                            <div class="wrapper-info">
                                    ...
                                    <span>
                                        <svg width="8" height="14" viewBox="0 0 8 14" fill="none"
                                            ...
                                            <rect x="1.45312" y="0.914062" width="9.25346" height="2.05632"
                                                transform="rotate(45 1.45312 0.914062)"></rect>
                                            <rect x="8" y="7.45703" width="9.25346" height="2.05632"
                                                transform="rotate(135 8 7.45703)"></rect>
                                        </svg>
                                    </span>
                                </a>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="product-wrapper wrapper-two aos-init" data-aos="fade-up">
                            <div class="wrapper-info">
    ...
    <section class="product brand aos-init" data-aos="fade-up">
        <div class="container">
            <div class="section-title">
            ...
            <div class="section-title">
                ...
                <div class="countdown-section">
                    <div class="countdown-items">
                        <span id="day" class="number" style="color: red;">189</span>
                        <span class="text">Days</span>
                    </div>
                    <div class="countdown-items">
                        <span id="hour" class="number" style="color: skyblue;">02</span>
                        <span class="text">Hours</span>
                    </div>
                    <div class="countdown-items">
                        <span id="minute" class="number" style="color: green;">21</span>
                        <span class="text">Minutes</span>
                    </div>
                    <div class="countdown-items">
                        <span id="second" class="number" style="color: red;">40</span>
