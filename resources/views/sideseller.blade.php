                ...
                <div class="seller-wrapper" data-aos="fade-up">
                    ...
                    <div class="seller-details">
                        <div class="seller-img">
                            <img src="{{asset('assets/images/homepage-one/seller-img/seller-img-6.png')}}" alt="img">
                        </div>
                        <div class="aurthor">
                            <h5>Rayhans</h5>
                        </div>
            ...
            <div class="col-lg-3">
                <div class="sidebar" data-aos="fade-right">
                    ...
                    <div class="sidebar-shop-section">
                        ...
                        <a href="{{url('produk')}}" class="shop-btn deal-btn">Shop Now </a>
                    </div>
                </div>
            </div>
            <div class="col-lg-9">
                            ...
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{url('detail')}}" class="product-details">Flower Design Dress
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{url('detail')}}" class="product-details">Black Suit
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{url('detail')}}" class="product-details">Blue Party Dress
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{url('detail')}}" class="product-details">Red Party Dress
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{url('detail')}}" class="product-details">White Checked Shirt
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{url('detail')}}" class="product-details">Red Baby Dress
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{url('detail')}}" class="product-details">Rainbow Sequin Skart
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{url('detail')}}" class="product-details">White T-Shirt
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{url('detail')}}" class="product-details">Blue Sleeveless Dress
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{url('detail')}}" class="product-details">Red Sleeveless Dress
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{url('detail')}}" class="product-details">Tom Checked Shirt
                                        </a>
                                        <div class="price">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{url('detail')}}" class="product-details">White Baby Hat
                                        </a>
                                        <div class="price">
