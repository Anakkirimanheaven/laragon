                ...
                <div class="col-lg-8">
                    <div class="blogs-wrapper">
                        <div class="wrapper-img">
                            <img src="{{asset('assets/images/homepage-one/about/blog-img-2.webp')}}" alt="img">
                        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="blog-post Latest-post">
                                    ...
                                    <div class="blogs-wrapper product-wrapper">
                                        <div class="wrapper-img">
                                            <img src="{{asset('assets/images/homepage-one/about/blog-img-1.webp')}}" alt="img">
                                        </div>
                                        <div class="wrapper-info">
                                    ...
                                    <div class="blogs-wrapper product-wrapper">
                                        <div class="wrapper-img">
                                            <img src="{{asset('assets/images/homepage-one/about/blog-img-3.webp')}}" alt="img">
                                        </div>
                                        <div class="wrapper-info">
