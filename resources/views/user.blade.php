                        ...
                        <div class="payment-section">
                            <div class="wrapper">
                                <div class="wrapper-item">
                                    <div class="wrapper-img">
                                        <img src="{{asset('assets/images/homepage-one/payment-img-1.png')}}" alt="payment">
                                    </div>
                                    <div class="wrapper-content">
                            ...
                            <div class="wrapper">
                                <div class="wrapper-item">
                                    <div class="wrapper-img">
                                        <img src="{{asset('assets/images/homepage-one/payment-img-2.png')}}" alt="payment">
                                    </div>
                                    <div class="wrapper-content">
                            ...
                            <div class="wrapper">
                                <div class="wrapper-item">
                                    <div class="wrapper-img">
                                        <img src="{{asset('assets/images/homepage-one/payment-img-3.png')}}" alt="payment">
                                    </div>
                                    <div class="wrapper-content">
                            ...
                            <div class="wrapper">
                                <div class="wrapper-item">
                                    <div class="wrapper-img">
                                        <img src="{{asset('assets/images/homepage-one/payment-img-4.png')}}" alt="payment">
                                    </div>
                                    <div class="wrapper-content">
