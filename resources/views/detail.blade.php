                    ...
                    <div class="product-info-img" data-aos="fade-right">
                        <div class="swiper product-top">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide slider-top-img">
                                    <img src="{{asset('assets/images/homepage-one/product-img/product-slider-img-2.webp')}}"
                                        alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img">
                                    <img src="{{asset('assets/images/homepage-one/product-img/product-slider-img-3.webp')}}"
                                        alt="img">
                                </div>
                                <div class="swiper-slide slider-top-img">
                                    <img src="{{asset('assets/images/homepage-one/product-img/product-slider-img-1.webp')}}"
                                ...
                                <div class="login-section account-section modal-main">
                                    <div class="review-form">
                                        <div class="review-content">
                                            ...
                                            <div class="close-btn">
                                                <img src="{{asset('assets/images/homepage-one/close-btn.png')}}"
                                ...
                                <div class="wrapper-aurthor">
                                    <div class="wrapper-info">
                                        <div class="aurthor-img">
                                            <img src="{{asset('assets/images/homepage-one/aurthor-img-1.webp')}}"
                                                alt="aurthor-img">
                                        </div>
