        ...
        <div class="container">
            <div class="header-top">
                <div class="header-profile">
                    <a href="{{url('user')}}"><span>Account</span></a>
                    <a href="{{url('order')}}"><span>Track Order</span></a>
                        ...
                        <div class="cart-submenu">
                            ...
                            <div class="cart-wrapper-section">
                                ...
                                <div class="cart-btn">
                                    ...
                                    <a href="{{url('checkout')}}" class="shop-btn checkout-btn">Checkout Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="header-nav">
                    ...
                    <ul class="menu-list">
                            ...
                            <div class="shop-menu">
                                <div class="menu-wrapper">
                                    <div class="menu-list">
                                        ...
                                        <ul>
                                            <li><a href="{{url('produk')}}">Shirt</a></li>
                                            <li><a href="{{url('produk')}}">Skart</a></li>
                                            <li><a href="{{url('produk')}}"> T-Shirt</a></li>
                                        </ul>
                                    </div>
                                    <div class="menu-list">
                                        <h5 class="menu-title">Bags</h5>
                                        <ul>
                                            <li><a href="{{url('produk')}}">HandBags</a></li>
                                            <li><a href="{{url('produk')}}">Mobile Bags</a></li>
                                            <li><a href="{{url('produk')}}">School Bags</a></li>
                                        </ul>
                                    </div>
                                    <div class="menu-list">
                                        <h5 class="menu-title">Cosmetics</h5>
                                        <ul>
                                            <li><a href="{{url('produk')}}">Liptics</a></li>
                                            <li><a href="{{url('produk')}}">Foundation</a></li>
                                            <li><a href="{{url('produk')}}"> Eye Liner</a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <li>
                            ...
                            <ul class="header-sub-menu">
                                ...
                                <li><a href="{{url('produk')}}">Shop Category Icon</a></li>
                                <li><a href="{{url('produk')}}">Shop List View</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{url('about')}}">
                        ...
                        <li>
                            ...
                            <ul class="header-sub-menu">
                                <li><a href="{{url('dblog')}}">Blog-details</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{url('user')}}">
                ...
                <div class="header-vendor-btn">
                    <a href="{{url('vendor')}}" class="shop-btn">
