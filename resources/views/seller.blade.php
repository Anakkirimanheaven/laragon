            ...
            <div class="row g-5">
                <div class="col-md-6">
                    <div class="seller-wrapper" data-aos="fade-right">
                        <div class="seller-info">
                            ...
                            <a href="{{url('sideseller')}}" class="shop-btn">Shop Now</a>
                        </div>
                        <div class="seller-details">
                            <div class="seller-img">
                                <img src="{{asset('assets/images/homepage-one/seller-img/seller-img-1.png')}}" alt="img">
                            </div>
                            <div class="aurthor">
                                <h5>mexuvo</h5>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="seller-wrapper" data-aos="fade-right">
                        ...
                        <div class="seller-details">
                            <div class="seller-img">
                                <img src="{{asset('assets/images/homepage-one/seller-img/seller-img-5.png')}}" alt="img">
                            </div>
                            <div class="aurthor">
                                <h5>Habbriyi</h5>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="seller-wrapper" data-aos="fade-left">
                        ...
                        <div class="seller-details">
                            <div class="seller-img">
                                <img src="{{asset('assets/images/homepage-one/seller-img/seller-img-4.png')}}" alt="img">
                            </div>
                            <div class="aurthor">
                                <h5>Rikayi Rox</h5>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="seller-wrapper" data-aos="fade-right">
                        ...
                        <div class="seller-details">
                            <div class="seller-img">
                                <img src="{{asset('assets/images/homepage-one/seller-img/seller-img-3.png')}}" alt="img">
                            </div>
                            <div class="aurthor">
                                <h5>Fusion X</h5>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="seller-wrapper" data-aos="fade-left">
                        ...
                        <div class="seller-details">
                            <div class="seller-img">
                                <img src="{{asset('assets/images/homepage-one/seller-img/seller-img-2.png')}}" alt="img">
                            </div>
                            <div class="aurthor">
                                <h5>Eecoms Shop</h5>
                            </div>
